 ...
 * @author 姜锋
 * @date 2018年10月4日 下午5:33:04 
 * @version V1.0   
 *
 */
public class GingerExpiredSessionStrategy extends AbstractSessionStrategy implements SessionInformationExpiredStrategy{

	public GingerExpiredSessionStrategy(SecurityProperties securityPropertie) {
