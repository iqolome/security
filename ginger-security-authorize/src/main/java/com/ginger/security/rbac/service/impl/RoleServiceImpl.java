...
import com.ginger.security.rbac.domain.RoleResource;
import com.ginger.security.rbac.dto.RoleInfo;
import com.ginger.security.rbac.repository.ResourceRepository;
import com.ginger.security.rbac.repository.RoleRepository;
import com.ginger.security.rbac.repository.RoleResourceRepository;
import com.ginger.security.rbac.repository.support.QueryResultConverter;
import com.ginger.security.rbac.service.RoleService;

/**
 * 
 * @Description: RoleServiceImpl
 * @author 姜锋
 * @date 2018年10月14日 下午6:00:10 
 * @version V1.0   
 *
 */
@Service
...
public class RoleServiceImpl implements RoleService {
	...
	/* (non-Javadoc)
	 * @see com.ginger.security.rbac.service.RoleService#create(com.ginger.security.rbac.dto.RoleInfo)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ginger.security.rbac.service.RoleService#update(com.ginger.security.rbac.dto.RoleInfo)
	 */
	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.ginger.security.rbac.service.RoleService#findAll()
	 */
	@Override
