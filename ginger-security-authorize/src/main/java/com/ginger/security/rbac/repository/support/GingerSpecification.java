...
/**
 * 
 * @Description: GingerSpecification
 * @author 姜锋
 * @date 2018年10月14日 下午5:58:16 
 * @version V1.0   
 *
 * @param <T>
 * @param <C>
 */
public abstract class GingerSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
		implements Specification<T> {

	/**
	 * @param condition
	 */
	public GingerSpecification(C condition) {
		super(condition);
	}
